...
<br>
 <table class="table table-hover"  >
  <thead>
    <tr>
      <th scope="col" style="text-align: center;" >Call Time</th>  
      <th scope="col" style="text-align: center;" >Call Length</th>  
      <th scope="col" style="text-align: center;" >Phone Number</th>
      <th scope="col" style="text-align: center;" >DNID</th> 
      ...
      <th scope="col" style="text-align: center;" >Agent_id</th>
      <th scope="col" style="text-align: center;" >Hang Up Reason</th>                                                               
    </tr>
 ...
 foreach ($call_data as $data) {
              ...
              echo '<td style="text-align: center;">'.$call[0].'</td>';              
              echo '<td style="text-align: center;">'.$call[1].'</td>';  
              echo '<td style="text-align: center;">'.$call[2].'</td>'; 
              echo '<td style="text-align: center;">'.$call[3] .'</td>';           
              echo '<td style="text-align: center;">'.$call[4].'</td>'; 
              echo '<td style="text-align: center;">'.$call[5].' '.$call[6].'</td>';
              echo '<td style="text-align: center;">'.$call[7].'</td>';                 
              echo '<td style="text-align: center;">'.$call[8].'</td>';
