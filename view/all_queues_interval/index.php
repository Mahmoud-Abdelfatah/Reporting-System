  ...
  <div class="card-body" style="">
							...
							<select class="selectpicker form-control" multiple data-live-search="true" name="queue[]" >
								<?php
                                   foreach ($queues as $queue) {
                                   	 echo '<option selected="selected" value="'.$queue['queue'].'">'.$queue['queue'].'</option>';
                                   }
								?>
        ...
        <div class='col-sm-5'>
          <div class="form-group">
            ...
            <div class='input-group date' id='interval'>
              <select class="selectpicker" name="interval">
			  ...
			  <input type="submit" name="all_queue_inteval_submit" value="Submit" class="btn btn-primary" style="float: right">
			</form>
  </div>
</div>
</div>
